...
enum {
	...
	//////////////////////////////////////////////////////////////////////////
	// kimi add...
	kKeyffmpegAVPacket		= 'fpkt',		// ffmpeg AVPacket
	kKeyffmpegAVFrame		= 'ffrm',		// ffmpeg AVFrame	
	kKeyTransmitJitter		= 'tjit',
	kKeyPktRecvNowUs		= 'prnw',
	kKeyffmpegCodecParam	= 'fcpr',
	kKeySpatialIndex		= 'spix',
	kKeyTraceNowUs			= 'trnu',
};
