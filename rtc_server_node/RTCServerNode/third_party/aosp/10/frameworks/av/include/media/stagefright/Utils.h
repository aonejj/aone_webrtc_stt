...
#include <media/stagefright/MetaData.h>			// kimi... add
...
#include <media/AudioResamplerPublic.h>		// kimi... add
#include <media/AVSyncSettings.h>			// kimi... add
...
//AString MakeUserAgent();	// kimi... disable for android
...
#if defined(__ANDROID__)
status_t sendMetaDataToHal(sp<MediaPlayerBase::AudioSink>& sink, const sp<MetaData>& meta);		// kimi disable
#endif
