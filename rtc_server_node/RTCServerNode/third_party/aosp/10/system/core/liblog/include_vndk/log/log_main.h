...
// addkimi
#if (_AONE_LOG_LEVEL_ <= ANDROID_LOG_VERBOSE)
#define ALOGV(...) __ALOGV(__VA_ARGS__)
#else
#define ALOGV(...)
#endif
...
// add kimi
#if (_AONE_LOG_LEVEL_ <= ANDROID_LOG_DEBUG)
#define ALOGD(...) ((void)ALOG(LOG_DEBUG, LOG_TAG, __VA_ARGS__))
#else
#define ALOGD(...)
#endif
...
// add kimi
#if (_AONE_LOG_LEVEL_ <= ANDROID_LOG_INFO)
#define ALOGI(...) ((void)ALOG(LOG_INFO, LOG_TAG, __VA_ARGS__))
#else
#define ALOGI(...)
#endif
...
// add kimi
#if (_AONE_LOG_LEVEL_ <= ANDROID_LOG_WARN)
#define ALOGW(...) ((void)ALOG(LOG_WARN, LOG_TAG, __VA_ARGS__))
#else
#define ALOGW(...)
#endif
...
// add kimi
#if (_AONE_LOG_LEVEL_ <= ANDROID_LOG_ERROR)
#define ALOGE(...) ((void)ALOG(LOG_ERROR, LOG_TAG, __VA_ARGS__))
#else
#define ALOGE(...)
#endif
