...
//#include <private/android_filesystem_config.h>	// kimi.... disable
#include <private/android_logger.h>

#include "config_read.h"
#include "logger.h"

#include <limits.h>			// kimi...	add
...
static bool uid_has_log_permission(uid_t uid) {
	return false;  // return (uid == AID_SYSTEM) || (uid == AID_LOG) || (uid == AID_ROOT) || (uid == AID_LOGD);		// kimi update => return false;
}
