...
// add kimi...
#define AONE_LOG_VERBOSE 2
#define AONE_LOG_DEBUG   3
#define AONE_LOG_INFO    4
#define AONE_LOG_WARN    5
#define AONE_LOG_ERROR   6
#define AONE_LOG_FATAL   7

#ifndef _AONE_LOG_LEVEL_
#define _AONE_LOG_LEVEL_ AONE_LOG_VERBOSE
#endif
