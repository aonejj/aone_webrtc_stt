...
#else
//#define ALOGV(...) __ALOGV(__VA_ARGS__)	// kimi origin
// addkimi
#if (_AONE_LOG_LEVEL_ <= AONE_LOG_VERBOSE)
 ...
 */
#ifndef ALOGD
//#define ALOGD(...) ((void)ALOG(LOG_DEBUG, LOG_TAG, __VA_ARGS__))	// kimi origin
// add kimi
#if (_AONE_LOG_LEVEL_ <= AONE_LOG_DEBUG)
 ...
 */
#ifndef ALOGI
//#define ALOGI(...) ((void)ALOG(LOG_INFO, LOG_TAG, __VA_ARGS__))	// kimi origin
// add kimi
#if (_AONE_LOG_LEVEL_ <= AONE_LOG_INFO)
 ...
 */
#ifndef ALOGW
//#define ALOGW(...) ((void)ALOG(LOG_WARN, LOG_TAG, __VA_ARGS__))	// kimi origin
// add kimi
#if (_AONE_LOG_LEVEL_ <= AONE_LOG_WARN)
 ...
 */
#ifndef ALOGE
//#define ALOGE(...) ((void)ALOG(LOG_ERROR, LOG_TAG, __VA_ARGS__))	// kimi origin
// add kimi
#if (_AONE_LOG_LEVEL_ <= AONE_LOG_ERROR)
