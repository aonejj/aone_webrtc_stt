...
//#include <utils/CallStack.h>		// kimi disable Callstack... 이걸 enable 시키면 일이 겁나 커짐

#include <utils/Mutex.h>

#include <log/log_main.h>			// kimi... add
...
#define DEBUG_REFS_CALLSTACK_ENABLED 0		// kimi update 1 -> 0
...
#if DEBUG_REFS_CALLSTACK_ENABLED		// kimi... add
        CallStack::logStack(LOG_TAG);
#endif
#else
